...
export default function OtpModal({ isOpen, onClose, onVerify, email, isLoading }) {
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Enter the 6-digit code sent to <br/><span className="text-violet-300 font-mono">{email}</span></p>
                </div>
              </div>
